...
const UcapanTerimaKasihSection = () => {
  return (
    <section className="text-center py-16 px-4 bg-blue-50 ">
      ...
      <h3 className="text-2xl font-cursive text-blue-700">Hawkins & Family</h3>

      {/* Logo dan footer */}
      <div className="mt-12 flex flex-col items-center gap-2">
        <div className="w-20 h-20 rounded-full border-2 border-blue-400 flex items-center justify-center">
          {/* <img
        ...
        <p className="text-sm text-blue-700 mt-2">Website Invitation</p>
        <p className="text-sm text-blue-700">by Kevin & Sashi</p>
      </div>
    </section>
  );
};
