...
export default function QuoteSection() {
  return (
    <section className="w-full h-[900px] py-16 flex justify-center items-center bg-pink-50 relative overflow-hidden">
      ...
      <motion.div
        className="relative z-10 bg-white/90 max-w-xl w-[80%] px-6 py-10 rounded-3xl shadow-lg border border-pink-200 text-center backdrop-blur-sm"
